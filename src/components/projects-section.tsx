...
const projects = [
	...
	},
	{
		...
		description: "This unified social media management platform offers advanced content scheduling and a comprehensive analytics dashboard. It provides engagement tracking across multiple platforms and seamless API integrations. Content creators and businesses gain powerful tools for managing their social media presence and analyzing performance metrics effectively, streamlining their online strategy.",
		icon: Users,
