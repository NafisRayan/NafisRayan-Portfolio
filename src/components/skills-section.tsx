...
export function SkillsSection() {
  return (
    <section id="hire-me" className="pt-12 sm:pt-16 lg:pt-24 pb-12 sm:pb-16 lg:pb-24 px-4 sm:px-6 lg:px-8 bg-background">
        ...
        <div className="space-y-12 sm:space-y-16">
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            <div className="space-y-3 sm:space-y-4">
              ...
              <div className="flex flex-wrap gap-1.5 sm:gap-2">
                ...
                <span className="text-xs sm:text-sm text-primary px-2 sm:px-3 py-1 rounded-full bg-primary/10 inline-block">React</span>
                <span className="text-xs sm:text-sm text-primary px-2 sm:px-3 py-1 rounded-full bg-primary/10 inline-block">Node.js</span>
                <span className="text-xs sm:text-sm text-primary px-2 sm:px-3 py-1 rounded-full bg-primary/10 inline-block">Express</span>
                ...
                <span className="text-xs sm:text-sm text-primary px-2 sm:px-3 py-1 rounded-full bg-primary/10 inline-block">Django</span>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            <div className="space-y-3 sm:space-y-4">
              ...
              <div className="flex flex-wrap gap-1.5 sm:gap-2">
                ...
                <span className="text-xs sm:text-sm text-primary px-2 sm:px-3 py-1 rounded-full bg-primary/10 inline-block">Android Development</span>
                <span className="text-xs sm:text-sm text-primary px-2 sm:px-3 py-1 rounded-full bg-primary/10 inline-block">iOS Development</span>
                ...
                <span className="text-xs sm:text-sm text-primary px-2 sm:px-3 py-1 rounded-full bg-primary/10 inline-block">Progressive Web Apps</span>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            <div className="flex items-center gap-2 text-primary mb-2">
              <span className="text-xs sm:text-sm text-muted-foreground">3D Modeling & Interactive Visualization</span>
            </div>
            <div className="space-y-3 sm:space-y-4">
              <p className="text-sm sm:text-base lg:text-lg text-muted-foreground leading-relaxed">
              ...
              <div className="flex flex-wrap gap-1.5 sm:gap-2">
                ...
                <span className="text-xs sm:text-sm text-primary px-2 sm:px-3 py-1 rounded-full bg-primary/10 inline-block">3D Graphics</span>
          ...
          <div className="space-y-3 sm:space-y-4">
            ...
            <div className="flex items-center gap-2 text-primary mb-2">
              <span className="text-xs sm:text-sm text-muted-foreground">Machine Learning & Intelligent Applications</span>
            </div>
            <div className="space-y-3 sm:space-y-4">
              <p className="text-sm sm:text-base lg:text-lg text-muted-foreground leading-relaxed">
              ...
              <div className="flex flex-wrap gap-1.5 sm:gap-2">
                ...
                <span className="text-xs sm:text-sm text-primary px-2 sm:px-3 py-1 rounded-full bg-primary/10 inline-block">AI Integration</span>
                <span className="text-xs sm:text-sm text-primary px-2 sm:px-3 py-1 rounded-full bg-primary/10 inline-block">Python</span>
              </div>
            </div>
          </div>
